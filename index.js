...
function join(username, password, ip, port, version) {
  return new Promise((resolve, reject) => {
    ...
    bot.on('login', async () => {
      bot.chat('WARNING: If you don\'t want your server to be joined (and likely destroyed) by random people, the only way to protect your server is by enabling a whitelist. Just banning this bot will NOT protect your server.');
